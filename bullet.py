...
class Bullet(Sprite):
    ...
    def check_top_wall(self):
        ...
        #for row in self.a_map.world_map:
        for x,y in self.a_map.world_map[int(self.rect.y/TILE)]: # upgrade
            rightTopX = x + TILE
            lefttBottomY = y + TILE
    ...
    def check_left_wall(self):
        ...
        for y,x in self.a_map.world_map_left_to_right[int(self.rect.x/TILE)]: # upgrade
            rightTopX = x + TILE
            lefttBottomY = y + TILE
    ...
    def check_bottom_wall(self):
        self.rightTopX = self.rect.x + BULLET_WIGHT
        self.lefttBottomY = self.rect.y + BULLET_HEIGHT
        for x,y in self.a_map.world_map[int(self.rect.y/TILE)]:
            rightTopX = x + TILE
            lefttBottomY = y + TILE
